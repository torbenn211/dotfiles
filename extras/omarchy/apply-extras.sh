...
install_app_configs() {
  ...
  [[ -f "$theme_dir/extras/apps/fastfetch-lain-logo.txt" ]] && copy_file "$theme_dir/extras/apps/fastfetch-lain-logo.txt" "$HOME/.config/fastfetch/lain-logo.txt"
...
uninstall_app_configs() {
  ...
  restore_or_remove "$HOME/.config/fastfetch/lain-logo.txt"
...
show_status() {
  ...
  status_line "fastfetch logo" "$HOME/.config/fastfetch/lain-logo.txt"
